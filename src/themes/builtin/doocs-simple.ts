...
.wechat-article h2 { padding: 0.3em 1.2em; margin: 4em auto 2em; color: #ffffff; background: #0F4C81; border-radius: 8px 24px 8px 24px; font-size: 1.3em; text-align: center; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.06); }
