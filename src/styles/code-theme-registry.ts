import { GENERATED_CODE_THEMES } from './generated/code-themes';
...
export const DEFAULT_CODE_THEME_ID = 'github-dark';

export class CodeThemeRegistry {
  get(id: string): string {
    return GENERATED_CODE_THEMES[id] ?? GENERATED_CODE_THEMES[DEFAULT_CODE_THEME_ID] ?? '';
  }
}
