...
- Reload the current `e27fe8d` build in the test Vault and repeat the basic UI checks above; the current code has not yet received a fresh desktop observation.
